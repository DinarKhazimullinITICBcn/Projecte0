...
public class BaseDatos {
	...
	public BaseDatos() {
		...
		libros.add(new Libro(2, "EL GRAN LABERINTO", "FERNANDO SABATER PERE", "ARIEL", "26/9/2006 0:00:00", "FICCION"));
		...
		libros.add(new Libro(10, "PERSONAJES MITICOS", "RICHARD MOLLIGNAM", "DEBATE", "7/9/2006 0:00:00", "ENTRETENIMIENTO"));
		libros.add(new Libro(11, "EL TIEMPO", "J.K ROWLINGS", "SALAMANDRA", "7/9/2006 0:00:00", "CIENCIA"));
		libros.add(new Libro(12, "DIETAS MEDITERRANEAS", "ARTURO PEREZ LOPEZ", "ARIEL", "16/9/2006 0:00:00", "GASTRONOMIA"));
		libros.add(new Libro(13, "ANGELES Y DEMONIOS", "DAN BROWN", "ARIEL", "17/9/2OO6 0:00:00", "FICCION"));
		...
		libros.add(new Libro(18, "NOTICIA DE UN SECUESTRO", "GABRIEL GARCIA GARIA", "ALFAGUARA", "7/12/2006 0:00:00", "FICCION"));
	}
